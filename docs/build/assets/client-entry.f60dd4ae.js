...
function Zn(e, n) {
  for (Tt[e] = n, e = 0; e < n.length; e++) ns.add(n[e]);
}
var He = !(
    typeof window > "u" ||
...
function ws(e) {
  return (e = Lc(e)), e !== null ? ks(e) : null;
}
function ks(e) {
...
function Dt(e) {
  ...
  for (; 0 < Je.length && ((t = Je[0]), t.blockedOn === null); )
    Ls(t), t.blockedOn === null && Je.shift();
}
...
function Ju(e, n, t, r) {
  if (Mr) {
    var l = au(e, n, t, r);
    if (l === null) Dl(e, n, r, Dr, t), Yo(e, r);
...
var lt = {
  ...
  Gc = ge(Xc),
  Zc = A({}, Xt, { relatedTarget: 0 }),
  Nl = ge(Zc),
  Jc = A({}, lt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  qc = ge(Jc),
  bc = A({}, lt, {
...
var of = A({}, Xt, {
  ...
  ff = ge(cf),
  df = A({}, lt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  pf = ge(df),
  mf = A({}, nl, {
    deltaX: function (e) {
...
function ri() {
  Ct && (Ct.detachEvent("onpropertychange", Us), (It = Ct = null));
}
function Us(e) {
  if (e.propertyName === "value" && tl(It)) {
    var n = [];
    Fs(n, It, e, Yu(e)), ys(Sf, n);
  }
}
function Cf(e, n, t) {
  e === "focusin"
    ? (ri(), (Ct = n), (It = t), Ct.attachEvent("onpropertychange", Us))
    : e === "focusout" && ri();
}
function _f(e) {
...
for (var Rl = 0; Rl < ii.length; Rl++) {
  var Ol = ii[Rl],
    Lf = Ol.toLowerCase(),
    Rf = Ol[0].toUpperCase() + Ol.slice(1);
  dn(Lf, "on" + Rf);
}
  ...
  if (!e[sr]) {
    (e[sr] = !0),
      ns.forEach(function (t) {
        t !== "selectionchange" && (Of.has(t) || Ml(t, !1, e), Ml(t, !0, e));
      });
...
function mn() {
  if (!Fl && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Ss(Xu, mn), l);
    } finally {
      (O = n), (Fl = !1);
    }
  }
...
var Vf = Ye.ReactCurrentBatchConfig;
function Ne(e, n) {
  if (e && e.defaultProps) {
...
function Eu(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = ta), co(e);
  var u = n.contextType;
  typeof u == "object" && u !== null
    ? (l.context = Ce(u))
...
function sa(e, n) {
  ...
  if (
    ...
    if (
      ((t.flags |= 2048),
      Wt(9, ca.bind(null, t, r, l, n), void 0, null),
      Z === null)
    )
      throw Error(y(349));
    (Pn & 30) !== 0 || aa(t, n, l);
...
function Sa(e, n, t) {
  return (Pn & 21) === 0
    ...
    : (Oe(t, n) || ((t = _s()), ($.lanes |= t), (Nn |= t), (e.baseState = !0)),
      n);
}
function Hf(e, n) {
  var t = O;
...
var Kr = {
  ...
  Kf = {
    ...
    useSyncExternalStore: function (e, n, t) {
      ...
      return (
        (l.queue = u),
        Ci(fa.bind(null, r, u, e), [e]),
        (r.flags |= 2048),
        Wt(9, ca.bind(null, r, u, t, n), void 0, null),
        t
      );
    },
    useId: function () {
...
function Ti(e, n, t, r, l) {
  ...
  if ((Xn(n, l), n.stateNode === null))
    _r(e, n), ra(n, t, r), Eu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function Jf(e, n, t, r, l, u, o) {
  ...
  if (((i = (o & e.childLanes) !== 0), ae || i)) {
    ...
    return Po(), (r = Vl(Error(y(421)))), dr(e, n, o, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
...
function td(e, n) {
  ...
  for (pu = { focusedElem: e, selectionRange: t }, Mr = !1, S = n; S !== null; )
...
function ja(e) {
  ...
  n !== null && ((e.alternate = null), ja(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[$t], delete n[hu], delete n[Uf], delete n[$f])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Ko(t), n === 1))
      e.tag === 0 ? Af(Ui.bind(null, e)) : Zs(Ui.bind(null, e)),
        Ff(function () {
          (R & 6) === 0 && mn();
        }),
        (t = null);
  ...
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || ce.current) ae = !0;
      ...
      if ((e.lanes & t) === 0 && (n.flags & 128) === 0)
        return (ae = !1), qf(e, n, t);
      ae = (e.flags & 131072) !== 0;
    }
  else (ae = !1), j && (n.flags & 1048576) !== 0 && Js(n, Ar, n.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Gu(n, t | 1), de(n, W()), (R & 6) === 0 && ((tt = W() + 500), mn()));
      }
      break;
    case 13:
      zn(function () {
...
vs = _o;
hs = zn;
var gd = { usingClientEntryPoint: !1, Events: [Gt, jn, ll, ps, ms, _o] },
  vt = {
...
ye.hydrateRoot = function (e, n, t) {
  ...
  if (
    ...
    (n = Ja(n, null, e, 1, t != null ? t : null, l, !1, u, o)),
    (e[We] = n.current),
    jt(e),
    r)
  )
...
var ba,
  Bi = Wi.exports;
(ba = Bi.createRoot), Bi.hydrateRoot;
var Oo = { exports: {} },
  vl = {};
/**
 * @license React
 ...
 */ var kd = br.exports,
  ...
  _d = kd.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function ec(e, n, t) {
  ...
  for (r in n) Cd.call(n, r) && !xd.hasOwnProperty(r) && (l[r] = n[r]);
  if (e && e.defaultProps)
...
const qr = Oo.exports.jsx,
  Hi = Oo.exports.jsxs;
function Pd(e) {
  const [n, t] = br.exports.useState(0);
  return Hi("div", {
    children: [
      qr("h1", { children: "This is Layout Component" }),
      Hi("div", {
        children: [
          n,
          qr("button", { onClick: () => t(n + 1), children: "Add Count" }),
        ],
      }),
    ],
  });
